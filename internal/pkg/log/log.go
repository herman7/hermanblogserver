...
import (
	...
	"github.com/herman7/hermanblogserver/internal/pkg/known"
)

// Logger 定义了 hermanblog 项目的日志接口. 该接口只包含了支持的日志记录方法.
...
func NewLogger(opts *Options) *zapLogger {
	...
	cfg := &zap.Config{
		// 是否在日志中显示调用日志所在的文件和行号，例如：`"caller":"hermanblog/hermanblog.go:75"`
